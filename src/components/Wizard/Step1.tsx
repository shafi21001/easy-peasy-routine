  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3 p-4">
      <div className="flex items-center gap-3">
        <label htmlFor="universityName" className="text-sm font-medium text-gray-700 w-48">University Name:</label>
        <input
          type="text"
          id="universityName"
      ...
      <div className="flex items-center gap-3">
        <label htmlFor="departmentName" className="text-sm font-medium text-gray-700 w-48">Department Name:</label>
        <input
          type="text"
          id="departmentName"
      ...
      <div className="flex items-center gap-3">
        <label htmlFor="numBatches" className="text-sm font-medium text-gray-700 w-48">Number of Batches:</label>
        <input
          type="number"
          id="numBatches"
          value={numBatches}
          ...
          min="1"
          max="20"
          className="border border-gray-300 rounded-md shadow-sm px-2 py-1 w-40"
          required
        />
      </div>
      <div className="flex items-center gap-3">
        <label htmlFor="numTeachers" className="text-sm font-medium text-gray-700 w-48">Number of Teachers:</label>
        <input
          type="number"
          id="numTeachers"
          value={numTeachers}
      ...
      <div className="flex items-center gap-3">
        <label htmlFor="numRooms" className="text-sm font-medium text-gray-700 w-48">Number of Rooms:</label>
        <input
          type="number"
          id="numRooms"
          value={numRooms}
      ...
      <div className="flex items-center gap-3">
        <label htmlFor="effectiveFrom" className="text-sm font-medium text-gray-700 w-48">Effective From Date:</label>
        <input
          type="date"
          id="effectiveFrom"
          value={effectiveFrom}
          onChange={(e) => setEffectiveFrom(e.target.value)}
          className="border border-gray-300 rounded-md shadow-sm px-2 py-1 w-56"
          required
        />
      </div>
      <div className="pt-2">
